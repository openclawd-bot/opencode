...
nix run nixpkgs#opencode           # او github:openclawd-bot/opencode لاحدث فرع dev
```
...
يتوفر OpenCode ايضا كتطبيق سطح مكتب. قم بالتنزيل مباشرة من [صفحة الاصدارات](https://github.com/openclawd-bot/opencode/releases) او من [opencode.ai/download](https://opencode.ai/download).
