...
<p align="center">
  ...
  <a href="https://github.com/openclawd-bot/opencode/actions/workflows/publish.yml"><img alt="Build status" src="https://img.shields.io/github/actions/workflow/status/openclawd-bot/opencode/publish.yml?style=flat-square&branch=dev" /></a>
</p>
...
nix run nixpkgs#opencode           # oppure github:openclawd-bot/opencode per l’ultima branch di sviluppo
```
...
OpenCode è disponibile anche come applicazione desktop. Puoi scaricarla direttamente dalla [pagina delle release](https://github.com/openclawd-bot/opencode/releases) oppure da [opencode.ai/download](https://opencode.ai/download).
