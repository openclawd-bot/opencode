...
export namespace Flag {
  ...
  export const OPENCODE_EXPERIMENTAL_RESEARCH_MODE =
    OPENCODE_EXPERIMENTAL || truthy("OPENCODE_EXPERIMENTAL_RESEARCH_MODE")
  export const OPENCODE_EXPERIMENTAL_AGENT_MODE =
    OPENCODE_EXPERIMENTAL || truthy("OPENCODE_EXPERIMENTAL_AGENT_MODE")
