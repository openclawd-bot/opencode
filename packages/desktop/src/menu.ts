    ...
    items: [
      ...
      await Submenu.new({
        ...
        items: [
          ...
          await MenuItem.new({
            action: () => openUrl("https://github.com/openclawd-bot/opencode/issues/new?template=feature_request.yml"),
            text: "Share Feedback",
          }),
          await MenuItem.new({
            action: () => openUrl("https://github.com/openclawd-bot/opencode/issues/new?template=bug_report.yml"),
            text: "Report a Bug",
          }),
        ],
      }),
