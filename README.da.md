...
OpenCode findes også som desktop-app. Download direkte fra [releases-siden](https://github.com/openclawd-bot/opencode/releases) eller [opencode.ai/download](https://opencode.ai/download).
