...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/openclawd-bot/opencode/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for openclawd-bot/opencode...\n")
