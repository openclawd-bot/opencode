...
nix run nixpkgs#opencode           # veya en güncel geliştirme dalı için github:openclawd-bot/opencode
```
...
OpenCode ayrıca masaüstü uygulaması olarak da mevcuttur. Doğrudan [sürüm sayfasından](https://github.com/openclawd-bot/opencode/releases) veya [opencode.ai/download](https://opencode.ai/download) adresinden indirebilirsiniz.
